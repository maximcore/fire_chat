...
/// @nodoc
class _$ChatEntityTearOff {
  const _$ChatEntityTearOff();

  _ChatEntity call({required int userId}) {
    return _ChatEntity(
      userId: userId,
    );
  }
...
/// @nodoc
const $ChatEntity = _$ChatEntityTearOff();
...
/// @nodoc
abstract class _$ChatEntityCopyWith<$Res> implements $ChatEntityCopyWith<$Res> {
  factory _$ChatEntityCopyWith(
          _ChatEntity value, $Res Function(_ChatEntity) then) =
      __$ChatEntityCopyWithImpl<$Res>;
  @override
  $Res call({int userId});
}

/// @nodoc
class __$ChatEntityCopyWithImpl<$Res> extends _$ChatEntityCopyWithImpl<$Res>
    implements _$ChatEntityCopyWith<$Res> {
  __$ChatEntityCopyWithImpl(
      _ChatEntity _value, $Res Function(_ChatEntity) _then)
      : super(_value, (v) => _then(v as _ChatEntity));

  @override
  _ChatEntity get _value => super._value as _ChatEntity;
...
class _$_ChatEntity implements _ChatEntity {
  const _$_ChatEntity({required this.userId});
  ...
  @override
  String toString() {
    return 'ChatEntity(userId: $userId)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_ChatEntityToJson(this);
  }
}

abstract class _ChatEntity implements ChatEntity {
  const factory _ChatEntity({required int userId}) = _$_ChatEntity;
